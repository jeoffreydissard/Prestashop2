...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'This functionality has been disabled.' => 'Cette fonctionnalité a été désactivée.',
  ...
  array (
    ...
    'Warning: you can use a PNG file for transparency, but it can take up to 1 second per page for processing. Please consider using JPG instead.' => 'Attention : vous pouvez utiliser un fichier PNG pour la transparence mais cela peut nécessiter 1 seconde de traitement par page. Utilisez plutôt le format JPG.',
    ...
    'Be careful! Please check your theme in an RTL language before generating the RTL stylesheet: your theme could be already adapted to RTL.\\nOnce you click on "Adapt to RTL", any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.' => 'Attention ! Merci de tester votre thème dans un langage RTL avant de générer la feuille de style RTL. Votre thème pourrait déjà avoir été adapté en RTL.\\nEn cliquant sur "Adapter en RTL", tous les fichiers spécifiques au RTL que vous auriez ajoutés à votre thème pourraient être supprimés par la nouvelle feuille de style.',
    ...
    'This selector lists the Zip files that you uploaded in the \'/themes\' folder.' => 'Cette liste contient les fichiers ZIP présents dans le dossier \'/themes\'.',
    'E.g. address, addresses, attachment' => 'Par exemple : addresse, addresses, pièce jointe',
    ...
    'WARNING: This feature may not be compatible with your theme, or with some of your modules. In particular, PNG mode is not compatible with the Watermark module. If you encounter any issues, turn it off by selecting "Use JPEG".' => 'ATTENTION : Cette fonctionnalité peut ne pas être compatible avec votre thème ou avec certains modules. En particulier, le mode PNG n\'est pas compatible avec le module Watermark / Filigrane. En cas de problème, désactivez cette fonctionnalité en sélectionnant "Utiliser le JPEG".',
    'Ranges from 0 (worst quality, smallest file) to 100 (best quality, biggest file).' => 'Va de 0 (faible qualité, petite taille de fichier) à 100 (meilleure qualité, taille du fichier importante).',
    'Recommended: 90.' => 'Recommandé : 90.',
    'PNG compression is lossless: unlike JPG, you do not lose image quality with a high compression ratio. However, photographs will compress very badly.' => 'La compression PNG est sans perte : à l\'inverse du JPG, vous ne perdez pas en qualité d\'image avec un grand ratio. Cependant, les images se compressent très mal.',
    'Ranges from 0 (biggest file) to 9 (smallest file, slowest decompression).' => 'Va de 0 (plus gros fichier) à 9 (plus petit fichier, décompression plus lente).',
    'Recommended: 7.' => 'Recommandé : 7.',
...
Cordialement,',
  ...
  array (
    ...
    'Warehouse did not exist, cannot set on product  %name% ' => 'L\'entrepôt n\'existant pas, impossible de l\'attribuer au produit %name% ',
    'Incorrect value for "Depends on stock" for product %name% ' => 'Valeur incorrecte pour "dépendant du stock" pour le produit %name% ',
  ...
  array (
    ...
    'Multiple value separator' => 'Séparateur de champs à valeurs multiples',
    'Comment:' => 'Commentaire :',
    'Newsletter subscription: Unable to delete customer using email.' => 'Souscription newsletter : impossible de supprimer le client utilisant l\'adresse email.',
    'Newsletter subscription: Unable to export customer using email.' => 'Souscription newsletter : impossible d\'exporter le client utilisant l\'adresse email.',
